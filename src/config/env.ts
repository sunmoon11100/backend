...
export const APP_NAME = process.env.APP_NAME ?? 'Bridge'
...
export const DB_TIMEZONE = process.env.DB_TIMEZONE ?? 'UTC' // for mysql = +00:00, for postgres = UTC
...
export const ORAO_NETWORK_APTOS_ADDRESS = process.env.ORAO_NETWORK_APTOS_ADDRESS ?? '0xab81318c79a3b65a1f23354494793fcc6c4fa44a69d0c0e656b7b1454ddd1bbf'
export const APTOS_NODE_URL = process.env.APTOS_NODE_URL ?? 'https://fullnode.mainnet.aptoslabs.com/v1'
export const INFURA_API_KEY = process.env.INFURA_API_KEY ?? 'cc89f492cadd4cec82ec565ae0931e02'
